...
"""This script is used to extract plain text out of a raw Wikipedia dump. Input is an xml.bz2 file provided
...
def segment_all_articles(file_path, min_article_character=200, workers=None, include_interlinks=False):
    ...
    min_article_character : int, optional
        Minimal number of characters for article (except titles and leading gaps).
...
def segment_and_write_all_articles(file_path, output_file, min_article_character=200, workers=None,
    ...
    output_file : str or None
        Path to output file in json-line format, or None for printing to stdout.
