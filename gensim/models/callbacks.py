...
class CoherenceMetric(Metric):
    ...
    def __init__(self, corpus=None, texts=None, dictionary=None, coherence=None,
        ...
        window_size : int, optional
            ...
            sliding windows as their probability estimator. For 'u_mass' this doesn't matter.
...
class Callback:
    """A class representing routines called reactively at specific phases during training.
    ...
    def set_model(self, model):
        ...
        self.model = model
        self.previous = None
        # check for any metric which needs model state from previous epoch
