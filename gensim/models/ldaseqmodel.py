...
#. Heavy lifting going on in the Sslm class - efforts can be made to cythonise mathematical methods, in particular,
   update_obs and the optimization takes a lot of time.
...
class LdaSeqModel(utils.SaveLoad):
    ...
    def __init__(
        ...
        em_min_iter : int, optional
            Minimum number of iterations until convergence of the Expectation-Maximization algorithm.
        em_max_iter : int, optional
            Maximum number of iterations until convergence of the Expectation-Maximization algorithm.
        chunksize : int, optional
            Number of documents in the corpus to be processed in a chunk.
    ...
    def fit_lda_seq(self, corpus, lda_inference_max_iter, em_min_iter, em_max_iter, chunksize):
        ...
        This method will iteratively setup LDA models and perform EM steps until the sufficient statistics converge,
    ...
    def dtm_vis(self, time, corpus):
        ...
        vocab : list of str
            The set of unique terms existing in the corpuse's vocabulary.
...
class LdaPost(utils.SaveLoad):
    ...
    def update_gamma(self):
        ...
        This operation is described in the original Blei LDA paper:
