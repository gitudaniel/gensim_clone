...
class AuthorTopicModel(LdaModel):
    ...
    def __init__(self, corpus=None, num_topics=100, id2word=None, author2doc=None, doc2author=None,
        ...
        # NOTE: as a distributed version of this model is not implemented, "distributed" is set to false. Some of the
        ...
        if serialized and not serialization_path:
            raise ValueError(
                "If serialized corpora are used, the path to a folder "
    ...
    def inference(self, chunk, author2doc, doc2author, rhot, collect_sstats=False, chunk_doc_idx=None):
        """Give a `chunk` of sparse document vectors, update gamma for each author corresponding to the `chunk`.

        Warnings
        --------
        The whole input chunk of documents is assumed to fit in RAM, chunking of a large corpus must be done earlier
        in the pipeline.
    ...
    def update(self, corpus=None, author2doc=None, doc2author=None, chunksize=None, decay=None, offset=None,
        ...
        Every time `update(corpus, author2doc)` is called, the new documents are appended to all the previously seen
        ...
        chunks_as_numpy : bool, optional
            ...
            array or not. Numpy can in some settings turn the term IDs into floats, these will be converted back into
        ...
        if corpus is None:
            ...
            # Add new authors to author2id/id2author dictionaries.
    ...
    def get_document_topics(self, word_id, minimum_probability=None):
        ...
        Warnings
        --------
        This method is invalid for model, use :meth:`~gensim.models.atmodel.AuthorTopicModel.get_author_topics` or
    ...
    def get_new_author_topics(self, corpus, minimum_probability=None):
        ...
        # Should not record the sstats, as we are going to delete the new author after calculation.
        try:
    ...
    def get_author_topics(self, author_name, minimum_probability=None):
        """Get topic distribution for the given author.
