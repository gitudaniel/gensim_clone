...
def load_facebook_model(path, encoding='utf-8'):
    ...
    model_file : str
        ...
        as Gensim requires only `.bin` file to load the entire fastText model.
    encoding : str, optional
...
class FastTextKeyedVectors(KeyedVectors):
    ...
    def get_sentence_vector(self, sentence):
        ...
        This function is a workaround of the official fasttext's get_sentence_vector().
...
def _unpack(m, num_rows, hash2index, seed=1, fill=None):
    ...
    #
    # Swap rows to transform hash2index into the identity function.
