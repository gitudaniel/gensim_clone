...
class MmCorpus(matutils.MmReader, IndexedCorpus):
    ...
    def __init__(self, fname):
        ...
        fname : {str, file-like object}
            ...
            (e.g. a compressed file is opened by `smart_open <https://github.com/RaRe-Technologies/smart_open>`_).
    ...
    def __iter__(self):
        ...
        ------
        list of (int, numeric)
            Documents in the `sparse Gensim bag-of-words format <intro.rst#core-concepts>`__.
