...
class IndexedCorpus(interfaces.CorpusABC):
    ...
    def serialize(serializer, fname, corpus, id2word=None, index_fname=None,
        ...
        metadata : bool, optional
            If True - ensure that serialize will write out article title to a pickle file.
        ...
        if offsets is None:
            raise NotImplementedError(
                "Called serialize on a class %s which doesn't support indexing!" % serializer.__name__
                )  # TODO: add `a ` before class
    ...
    def __getitem__(self, docno):
        ...
        ------
        RuntimeError
            If index doesn't exist.  #TODO - fix isn't to doesn't
