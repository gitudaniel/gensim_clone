...
class TextCorpus(interfaces.CorpusABC):
    ...
    def init_dictionary(self, dictionary):
        ...
        dictionary : :class:`~gensim.corpora.dictionary.Dictionary`, optional
            If a dictionary is provided, it will not be updated with the given corpus on initialization.
            If None - a new dictionary will be built for the given corpus.
    ...
    def sample_texts(self, n, seed=None, length=None):
        ...
        length : int, optional
            Value will be used as corpus length (because calculate length of corpus can be costly operation).
        ...
        ------
        list of str
            Sampled document as a sequence of tokens.
    ...
    def __len__(self):
        ...
        Warnings
        --------
        If self.length is None - will read all corpus to calculate this attribute through
...
class TextDirectoryCorpus(TextCorpus):
    ...
    def __init__(self, input, dictionary=None, metadata=False, min_depth=0, max_depth=None,
        ...
        kwargs : keyword arguments passed through to the `TextCorpus` constructor.
            See :meth:`gensim.corpora.textcorpus.TextCorpus.__init__` docstring for more details on these.
