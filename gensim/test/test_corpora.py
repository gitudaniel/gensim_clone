...
# Needed for the test_custom_tokenizer in the TestWikiCorpus class.
...
class TestWikiCorpus(TestTextCorpus):
    ...
    def test_lower_case_set_true(self):
        """
        Set the parameter lower to True and check that upper case 'Anarchism' token doesn't exist
        """
