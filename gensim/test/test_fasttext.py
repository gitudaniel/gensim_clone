...
class SaveGensimByteIdentityTest(unittest.TestCase):
    """
    This class contains tests that check the following scenario:
...
class SaveFacebookByteIdentityTest(unittest.TestCase):
    ...
    def _check_roundtrip_file_file(self, sg):
        ...
        # fasttext tool creates both *vec and *bin files, so we have to remove both, even though *vec is unused
