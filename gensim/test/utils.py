...
def datapath(fname):
    ...
    Example
    -------
    Let's get path of test Glove data file and check if it exists.
...
def get_tmpfile(suffix):
    ...
    This function doesn't create files (only generate unique name).
...
def temporary_file(name=""):
    ...
    Temporary directory with included files will be deleted at the end of context. Note, it won't create file.
    ...
    files) will be deleted at the end of context.
    ...
    .. sourcecode:: pycon
        ...
        ...     print("Does this file exist? {}".format(os.path.exists(tf)))
        ...     print("Does this folder exist? {}".format(os.path.exists(os.path.dirname(tf))))
        Does this file exist? True
        Does this folder exist? True
        >>>
        >>> print("Does this file exist? {}".format(os.path.exists(tf)))
        Does this file exist? False
        >>> print("Does this folder exist? {}".format(os.path.exists(os.path.dirname(tf))))
        Does this folder exist? False
